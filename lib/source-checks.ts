...
export type SourceCheck={status:"waiting"|"pinging"|"checking"|"available"|"failed"|"blocked"|"unsupported"|"unconfirmed";okAt?:number;elapsedMs?:number;connectMs?:number;reason?:string};
